  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        $sql = "SELECT feedback.id, feedback.q1, feedback.q2, feedback.q3, feedback.comment, student.firstname, student.lastname, faculty.name FROM feedback LEFT JOIN student ON feedback.student_id = student.username LEFT JOIN faculty ON feedback.faculty_id = faculty.faculty_id ORDER BY id DESC LIMIT {$offset},{$limit}";
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              <td class='delete'><a style="color:red;" href='delete-feedback.php?id=<?php echo $row['id']?>'><!-- <i class='fa fa-trash-o'></i> -->Delete</a></td>
            </tr>
            <?php 
          }
          ?>
