            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_assoc($result)) {
               ...
               <tr>
                ...
                <td class='edit'><a href='update-user.php?id=<?php echo $row["college_id"]; ?>'><!-- <i class='fa fa-edit'></i> -->Edit</a></td>
                <td class='delete'><a style="color:red;" href='delete-user.php?id=<?php echo $row["username"]; ?>'><!-- <i class='fa fa-trash-o'></i> -->Delete</a></td>
              </tr>
              <?php
            }
            ?>
