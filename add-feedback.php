...
if (isset($_POST['submit'])) {
	...
	// if umcommented have to change query and form
	...
	$sql = "INSERT INTO feedback (faculty_id, student_id, q1, q2, q3, comment)
	VALUES('{$faculty}', '{$student}','{$q1}', '{$q2}', '{$q3}', '{$comment}')";
		...
		<div class="row">
			...
			<div class="col-md-offset-3 col-md-6">
				...
				<form  action="<?php echo $_SERVER['PHP_SELF'] ?>" method ="POST" autocomplete="off">
					...
					<!-- uncomment and change the labels -->
					<!-- <div class="form-group">
						<label>Exam Guidence</label>
					...
					<div class="form-group">
						<label>Exam Guidence</label>
						<input type="radio" name="q7" value="Very Poor" required/> Very Poor
						<input type="radio" name="q7" value="Poor" required/> Poor
						<input type="radio" name="q7" value="Normal" required/> Normal
						<input type="radio" name="q7" value="Good" required/> Good
						<input type="radio" name="q7" value="Excellent" required/> Excellent
					</div>
					<div class="form-group">
						<label>Exam Guidence</label>
						<input type="radio" name="q8" value="Very Poor" required/> Very Poor
						<input type="radio" name="q8" value="Poor" required/> Poor
						<input type="radio" name="q8" value="Normal" required/> Normal
						<input type="radio" name="q8" value="Good" required/> Good
						<input type="radio" name="q8" value="Excellent" required/> Excellent
					</div>
					<div class="form-group">
						<label>Exam Guidence</label>
						<input type="radio" name="q9" value="Very Poor" required/> Very Poor
						<input type="radio" name="q9" value="Poor" required/> Poor
						<input type="radio" name="q9" value="Normal" required/> Normal
						<input type="radio" name="q9" value="Good" required/> Good
						<input type="radio" name="q9" value="Excellent" required/> Excellent
					</div> -->
					<div class="form-group">
